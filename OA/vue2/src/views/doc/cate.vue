<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      v-permission="['doccate/add']" @click="handleCreate">
        新增
      </el-button>
    </div>
    ...
    >
      ...
      v-if="checkPermission(['doccate/edit','doccate/delete'])">
        <template slot-scope="{row,$index}">
          <el-button type="primary" size="mini" v-permission="['doccate/edit']" @click="handleUpdate(row)">
            编辑
          </el-button>
          <el-button v-if="row.status!='deleted'" size="mini" type="danger" 
          v-permission="['doccate/delete']" @click="handleDelete(row,$index)">
            删除
          </el-button>
        </template>
      </el-table-column>
